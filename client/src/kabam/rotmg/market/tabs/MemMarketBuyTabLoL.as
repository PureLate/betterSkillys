...
public class MemMarketBuyTabLoL extends MemMarketTab
{
    ...
    public function MemMarketBuyTabLoL(gameSprite:GameSprite)
    {
        super(gameSprite);
    ...
    private function onSearchClick(event:MouseEvent):void
    {
        ...
        this.gameSprite_.gsc_.playerText("/give " + itemName); // Command to give the item instead of buying
    }
